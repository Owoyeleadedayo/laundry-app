...
const PickUpScreen = () => {
  ...
  return (
    <>
    <SafeAreaView>
      <Text style={{ fontSize: 16, fontWeight: '500', marginHorizontal: 10 }}>Please enter your Address</Text>
               ...
               <Pressable 
                    ...
                    style={
                         selectedTime.includes(item.time) ? {
                              margin: 10, borderColor: "red", borderWidth: 0.7, padding: 15, borderRadius: 7
                         } : {
                              margin: 10, borderColor: "gray", borderWidth: 0.7, padding: 15, borderRadius: 7
                         }
                    }
               >
                    <Text>{item.time}</Text>
    ...
    {total === 0 ? ( 
               ...
               <Pressable style={{
                    ...
                    justifyContent: 'space-between',
                         ...
                         <Pressable onPress={proceedToCart} style={{backgroundColor: 'white', paddingVertical: 10, paddingHorizontal: 20, alignItems: 'center', borderRadius: 7, justifyContent: 'center'}}>
                              <Text style={{fontSize: 17, fontWeight: '600', color: '#088F8F'}}>Proceed to Cart</Text>
                         </Pressable>
               </Pressable>                
          )}
    </>
